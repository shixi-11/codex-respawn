const rows = {
 en:['When is the next reset?','Next public reset','No confirmed time','Your local time','Reset credits & extra usage','No verified offer yet','Check my usage','Awaiting confirmation','Reset announced complete','Announcement cancelled','Source','+50% weekly Claude Code usage','Applied automatically to eligible plans','Offer ends'],
 zh:['还要多久重置？','下一次公开重置','时间尚未确认','你的本地时间','重置卡与额外额度','暂无已核实的赠送消息','查看我的额度','等待重置完成确认','已宣布重置完成','公告已取消','消息来源','Claude Code每周额度增加50%','符合条件的方案自动获得','活动截止'],
 'zh-Hant':['還要多久重置？','下一次公開重置','時間尚未確認','你的當地時間','重置卡與額外額度','暫無已核實的贈送消息','查看我的額度','等待重置完成確認','已宣布重置完成','公告已取消','消息來源','Claude Code每週額度增加50%','符合條件的方案自動獲得','活動截止'],
 ja:['次のリセットはいつ？','次回の一斉リセット','時刻は未確認','現地時刻','リセット権・追加利用枠','確認済みの特典はありません','利用状況を確認','完了の発表待ち','リセット完了の発表あり','発表は取り消されました','情報源','Claude Codeの週間利用枠が50%増加','対象プランに自動適用','終了日時'],
 ko:['다음 초기화까지 얼마나 남았나요?','다음 일괄 초기화','확인된 시간 없음','현지 시간','초기화 이용권 및 추가 사용량','확인된 혜택 없음','내 사용량 확인','완료 확인 대기 중','초기화 완료 발표','발표 취소','출처','Claude Code 주간 사용량 50% 추가','대상 요금제에 자동 적용','혜택 종료'],
 es:['¿Cuándo se restablecen los límites?','Próximo restablecimiento general','Sin horario confirmado','Tu hora local','Créditos de restablecimiento y uso extra','Sin ofertas verificadas','Consultar mi uso','Pendiente de confirmación','Restablecimiento confirmado por el anuncio','Anuncio cancelado','Fuente','50% más de uso semanal de Claude Code','Aplicación automática a planes elegibles','Fin de la oferta'],
 fr:['Quand les limites seront-elles réinitialisées ?','Prochaine réinitialisation générale','Horaire non confirmé','Votre heure locale','Crédits de réinitialisation et usage supplémentaire','Aucune offre vérifiée','Voir mon utilisation','En attente de confirmation','Réinitialisation annoncée comme terminée','Annonce annulée','Source','50 % d’utilisation hebdomadaire en plus pour Claude Code','Application automatique aux offres éligibles','Fin de l’offre'],
 de:['Wann werden die Limits zurückgesetzt?','Nächste allgemeine Zurücksetzung','Kein bestätigter Zeitpunkt','Deine Ortszeit','Reset-Guthaben und zusätzliche Nutzung','Kein bestätigtes Angebot','Meine Nutzung prüfen','Bestätigung ausstehend','Zurücksetzung als abgeschlossen gemeldet','Ankündigung zurückgezogen','Quelle','50 % mehr wöchentliche Claude-Code-Nutzung','Automatisch für berechtigte Tarife','Angebot endet'],
 ar:['متى تُعاد حدود الاستخدام؟','إعادة الضبط العامة التالية','لا يوجد موعد مؤكّد','توقيتك المحلي','أرصدة إعادة الضبط والاستخدام الإضافي','لا توجد عروض موثّقة بعد','عرض استخدامي','بانتظار تأكيد الاكتمال','أُعلن اكتمال إعادة الضبط','أُلغي الإعلان','المصدر','زيادة الاستخدام الأسبوعي لـClaude Code بنسبة 50٪','تُطبّق تلقائيًا على الخطط المؤهلة','انتهاء العرض']
};
