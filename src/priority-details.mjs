...
// The seven-day feed includes the latest posts, even when featured above.
...
const replacementLabels={en:'Replacement reset credit',zh:'重置卡补发','zh-Hant':'重置卡補發',ja:'リセット権の再付与',ko:'초기화 이용권 재지급',es:'Crédito de restablecimiento de reemplazo',fr:'Crédit de réinitialisation de remplacement',de:'Ersatz-Reset-Guthaben',ar:'رصيد إعادة ضبط تعويضي'};
